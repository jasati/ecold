(function(){
    ...
    ItemSelModalController.$inject = ['$filter','$q','Movimento', '$modalInstance', '$scope', '$modal', 'config', 'ItemService','logger'];
    /* @ngInject */
    function ItemSelModalController($filter, $q,Movimento, $modalInstance, $scope, $modal, config, ItemService,logger) {
        var vm = this;
